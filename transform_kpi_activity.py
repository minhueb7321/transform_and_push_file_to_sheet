import pandas as pd
import gspread
import warnings ; import os; import time ; from datetime import datetime
...
def push_data(df ,sheet_id, sheet_name):
    gc = gspread.service_account(filename = r'F:\Documents\BigqueryJson\sheet_push_data.json')
